...
_rgb_shm = shared_memory.SharedMemory(name="zed_rgb", create=True, size=int(np.prod(RGB_SHAPE)))
_depth_shm = shared_memory.SharedMemory(name="zed_depth", create=True, size=int(np.prod(DEPTH_SHAPE) * 4))
